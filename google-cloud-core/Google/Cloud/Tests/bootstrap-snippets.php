...
use Google\Cloud\Tests\Snippet\Coverage\Coverage;
use Google\Cloud\Tests\Snippet\Coverage\Scanner;
use Google\Cloud\Tests\Snippet\Parser\Parser;

require __DIR__ . '/../../../vendor/autoload.php';

$parser = new Parser;
$scanner = new Scanner($parser, __DIR__ . '/../Core');
